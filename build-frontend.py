...
os.chdir('app\\www\\EffectPlayerClient')
os.system('pwd')
...
for file in static_files:
    ...
    shutil.move(file, f'app\\www\\static\\{basename}')

for file in asset_files:
    os.makedirs("app\\www\\static\\assets\\", exist_ok=True)
    basename = os.path.basename(file)
    print(f'  Moving to static: {basename}')
    shutil.move(file, f'app\\www\\static\\assets\\{basename}')

for file in template_files:
    basename = os.path.basename(file)
    print(f'  Moving to template: {basename}')
    shutil.move(file, f'app\\www\\templates\\{basename}')
